/**
 * Listing Studio 页 - 能力与输入字段 fallback（真源：GET /listing-studio/capabilities）
 */
...
/** 生产默认：空输入；开发环境可预填示例便于调试 */
export const EMPTY_LISTING_STUDIO_INPUTS: ListingStudioInputs = {}

const DEV_SAMPLE_LISTING_STUDIO_INPUTS: ListingStudioInputs = {
...
export const DEFAULT_LISTING_STUDIO_INPUTS: ListingStudioInputs = import.meta.env.DEV
  ? DEV_SAMPLE_LISTING_STUDIO_INPUTS
  : EMPTY_LISTING_STUDIO_INPUTS
