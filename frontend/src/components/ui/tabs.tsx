...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-lg border border-border/70 bg-muted/45 p-1 text-muted-foreground shadow-sm shadow-black/[0.02] dark:shadow-black/20',
      className
    )}
    {...props}
  />
