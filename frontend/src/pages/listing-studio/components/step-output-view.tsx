...
import {
  useListingStudioCapabilities,
  type ListingStudioCapabilitiesConfig,
} from '@/hooks/use-listing-studio-capabilities'
import { Copy, Check, ChevronDown, ChevronRight } from '@/lib/lucide-icons'
import { cn } from '@/lib/utils'
import type { ListingStudioJobStep } from '@/types/listing-studio'
...
export function StepOutputView({
  ...
  const { config: hookConfig } = useListingStudioCapabilities()
  const caps = capabilityConfig ?? hookConfig
