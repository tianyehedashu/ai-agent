...
- [思考参数测试](file://backend/tests/unit/gateway/domain/test_thinking_param.py)
- [思考参数实现](file://backend/domains/gateway/domain/thinking_param.py)
- [路由部署参数测试](file://backend/tests/unit/gateway/test_router_deployment_params.py)
- [路由模型名称编解码测试](file://backend/tests/unit/gateway/test_router_model_name_codec.py)
- [路由页面出口](file://frontend/src/routes/route-page-outlet.tsx)
- [路由页面出口键](file://frontend/src/routes/route-page-outlet-key.ts)
- [路由策略选择器](file://frontend/src/features/gateway-models/routes/routing-strategy-select.tsx)
- [路由拓扑编辑器](file://frontend/src/features/gateway-models/routes/route-topology-editor.tsx)
- [路由用量键构建](file://frontend/src/features/gateway-models/list/usage-keys.ts)
- [前端思考参数测试](file://frontend/src/features/gateway-shared/thinking-param.test.ts)
</cite>

## 更新摘要
**变更内容**
- 新增思考参数功能测试覆盖，包括Moonshot/Kimi模型检测与推理参数推断
- 新增路由参数构建相关测试，涵盖部署参数解析、模型名称编解码
- 扩展前端路由组件测试，包括路由策略选择与拓扑编辑
- 更新测试金字塔以反映新增功能的测试覆盖
...
**更新** 新增对思考参数功能、Moonshot/Kimi模型检测、路由参数构建等新功能的测试覆盖策略。
...
**更新** 新增思考参数推断、Moonshot/Kimi模型检测、路由部署参数解析等新功能的单元测试。
...
**更新** 新增路由策略选择、拓扑编辑等前端路由功能的端到端测试场景。

**章节来源**
- [端到端测试配置](file://backend/tests/e2e/conftest.py)
- [前端路由策略选择器](file://frontend/src/features/gateway-models/routes/routing-strategy-select.tsx)
- [前端路由拓扑编辑器](file://frontend/src/features/gateway-models/routes/route-topology-editor.tsx)
- [前端路由页面出口](file://frontend/src/routes/route-page-outlet.tsx)
- [前端路由页面出口键](file://frontend/src/routes/route-page-outlet-key.ts)
- [前端测试示例：聊天API](file://frontend/src/api/chat.test.ts)
- [前端测试示例：会话API](file://frontend/src/api/session.test.ts)
- [前端测试示例：用户API](file://frontend/src/api/user.test.ts)
- [前端测试示例：视频任务API](file://frontend/src/api/videoTask.test.ts)
...
**更新** 新增思考参数功能、Moonshot/Kimi模型检测、路由参数构建等新功能的测试策略，进一步完善了测试金字塔的覆盖范围。
...
- 新增测试组件
  - 思考参数测试：覆盖Moonshot/Kimi模型检测、推理参数推断、标签丰富化等功能
  - 路由参数测试：覆盖部署参数解析、模型名称编解码、路由策略选择等
  - 前端路由测试：覆盖路由页面出口、策略选择器、拓扑编辑器等组件
