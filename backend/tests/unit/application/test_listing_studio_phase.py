...
def _fake_step(
    capability_id: str,
    status: str = ListingStudioJobStepStatus.COMPLETED,
...
# ===========================================================================
# _build_full_input (via ListingStudioUseCase)
# ===========================================================================
...
class TestBuildFullInput:
    ...
    def _build(
        ...
        uc = ListingStudioUseCase.__new__(ListingStudioUseCase)
...
class TestRunStep:
    ...
    async def test_run_step_renders_and_executes(self, db_session):
        ...
        try:
            ...
            with (
                self._mock_visible_text_models(uc),
                patch.dict(
