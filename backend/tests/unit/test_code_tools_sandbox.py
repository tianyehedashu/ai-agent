...
from tools.code_tools import RunPythonTool, RunShellTool
...
class TestSandboxModeSelection:
    ...
    def test_local_mode_uses_local_executor(self):
        """测试本地模式使用本地执行器"""
        from core.sandbox.executor import LocalExecutor
...
class TestMemoryLimitParsing:
    ...
    def test_parse_megabytes(self):
        """测试解析 MB 单位"""
        from tools.code_tools import _parse_memory_limit
