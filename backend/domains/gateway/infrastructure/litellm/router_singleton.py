...
from domains.gateway.domain.catalog.deployment_weight import coerce_deployment_weight
...
from domains.gateway.domain.upstream.upstream_profile import UpstreamCallShape, UpstreamProtocol
...
async def _build_lazy_virtual_route_deployments(
    ...
    *,
    ...
    from domains.gateway.domain.route.route_model_ref import parse_route_model_ref
