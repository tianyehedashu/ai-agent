...
from domains.gateway.domain.credential.credential_probe import (
...
from domains.gateway.domain.proxy.coding_agent_ua import resolve_coding_agent_ua
...
class CredentialUpstreamCatalogService:
    ...
    async def _probe_credential_row(
        ...
        *,
        ...
        user_agent = resolve_coding_agent_ua(
