...
from domains.gateway.application.proxy.platform_api_key_proxy_dto import (
...
class GatewayAccessUseCase:
    ...
    async def record_virtual_key_usage(self, vkey_id: uuid.UUID) -> None:
        from domains.gateway.application.vkey.virtual_key_touch import schedule_virtual_key_touch
