...
from domains.gateway.domain.catalog.deployment_weight import assert_deployment_weight
...
from domains.gateway.domain.litellm.litellm_capability_mapping import strip_litellm_capability_tags
...
class ModelWritesMixin:
    ...
    async def create_personal_models(
        ...
        *,
        ...
        from domains.gateway.application.catalog.personal_models import (
    ...
    async def update_personal_model(
        ...
        from domains.gateway.application.catalog.personal_models import capability_for_model_type
    ...
    async def _finalize_gateway_model_deletions(
        ...
        *,
        ...
        if not deleted_names:
            return 0, 0
        if deleted_ids:
            from domains.gateway.application.grant.resource_grant_cleanup import (
