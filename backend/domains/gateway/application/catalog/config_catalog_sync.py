...
from domains.gateway.domain.provider.provider_env_catalog import (
    ProviderEnvSnapshot,
...
from domains.gateway.domain.upstream.upstream_endpoint import infer_profile_id_from_env_api_base
...
from .catalog_capability import infer_catalog_capability
from .gateway_catalog_seed import resolve_catalog_seed_models
from .gateway_model_tags_pipeline import build_gateway_model_tags
from .model_reference_prune import prune_gateway_model_name_references
...
async def _ensure_system_credential(
    ...
    *,
    ...
    if not plain_key and (settings.app_env != "production" or os.environ.get("PYTEST_VERSION")):
