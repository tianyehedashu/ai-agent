...
from domains.gateway.application.budget.budget_service import BudgetService
from domains.gateway.application.budget.budget_usage_persist import (
...
from domains.gateway.application.quota.quota_plan_usage_persist import (
...
from domains.gateway.domain.quota.period_reset_anchor import period_reset_anchor_from_row
from domains.gateway.domain.quota.quota_plan import ENTITLEMENT_NS
...
from .prompt_cache_middleware import (
    apply_gateway_cache_hit_to_metadata,
)
from .proxy_context import BudgetAnchorCoord, ProxyContext
from .proxy_stream_settlement import (
