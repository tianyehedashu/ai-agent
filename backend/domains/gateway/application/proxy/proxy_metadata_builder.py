...
from domains.gateway.application.route.route_snapshot_cache import get_route_snapshot_metadata
from domains.gateway.application.route.router_model_name import router_model_name_for_client
from domains.gateway.domain.proxy.guardrail_policy import effective_guardrail_enabled
from domains.gateway.domain.route.route_snapshot import build_delegated_route_snapshot_metadata
...
from .proxy_timing import ProxyPrepareTimings
...
class ProxyMetadataBuilder:
    ...
    async def _merge_user_and_model_metadata(
        ...
        *,
        ...
        client_raw = ctx.client_raw_model
        if client_raw:
            meta["gateway_route_name"] = client_raw
            meta["gateway_dispatched_via_prefix"] = ctx.dispatched_via_prefix
            meta["gateway_route_name_normalized"] = virtual_model
        else:
