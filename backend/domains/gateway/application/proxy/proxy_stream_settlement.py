...
from domains.gateway.application.upstream.upstream_cost_resolver import resolve_upstream_cost_usd
from domains.gateway.domain.usage.normalized_usage import normalized_usage_from_raw
...
async def finalize_deferred_stream_settlement(
    ...
    *,
    ...
    from .proxy_response_adapter import settle_usage
