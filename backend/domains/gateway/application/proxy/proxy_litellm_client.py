...
from domains.gateway.domain.litellm.litellm_credential_extra_keys import litellm_api_key_param_name
...
class ProxyLiteLLMClient:
    ...
    async def _invoke_router_or_direct(
        ...
        *,
        ...
        from domains.gateway.domain.route.router_model_name import decode_router_model_name
        from domains.gateway.infrastructure.litellm.router_singleton import (
            ensure_gateway_callbacks,
        )
