...
from .entitlement_config_cache import (
    enforceable_quotas,
...
from .entitlement_model_status import ENTITLEMENT_RESETTING_SOON_SECONDS
...
if TYPE_CHECKING:
    ...
    from .entitlement_config_cache import EntitlementPlanConfigRow
