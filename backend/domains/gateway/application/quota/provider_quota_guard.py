...
from domains.gateway.domain.quota.quota_plan import PROVIDER_NS, PlanQuotaSpec, QuotaPlanReservation
...
from .provider_quota_config_cache import (
...
from .quota_plan_callback_settlement_shared import to_plan_uuid
from .quota_plan_service import QuotaPlanService
...
def get_provider_quota_guard() -> ProviderQuotaGuard:
    ...
    if _provider_quota_guard_singleton is None:
        ...
        from .quota_plan_service import get_quota_plan_service
