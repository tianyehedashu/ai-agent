...
from domains.gateway.domain.provider.volcengine_image import parse_volcengine_image_endpoint_id
...
if TYPE_CHECKING:
    ...
    from domains.gateway.infrastructure.litellm.router_singleton import PricingLookup
