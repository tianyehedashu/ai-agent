...
from domains.gateway.application.grant.resolve_model_cache import invalidate_for_tenant
...
from domains.gateway.application.grant.system_grants_cache import invalidate_grants_for_team
...
def invalidate_gateway_read_caches_for_tenant_with_grants(tenant_id: UUID) -> None:
    ...
    from domains.gateway.application.grant.resource_grants_cache import _LOCAL
...
def clear_all_gateway_read_caches_for_tests() -> None:
    ...
    from domains.gateway.application.grant.system_grants_cache import clear_grants_cache_for_tests
    from domains.gateway.application.quota.entitlement_config_cache import (
