...
from .usage_metrics import merge_gateway_usage_slices
from .usage_reads import (
            ...
            items.append(
                {
                    ...
                    "workspace": {
                        ...
                        "cached_tokens": int(w.get("cached_tokens", 0)),
                        "cache_creation_tokens": int(w.get("cache_creation_tokens", 0)),
                        "cost_usd": w["cost_usd"],
                    },
                    "user": {
                        ...
                        "cache_creation_tokens": int(u.get("cache_creation_tokens", 0)),
                        "cost_usd": u["cost_usd"],
                    },
                }
            )
