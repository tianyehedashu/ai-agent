"""
Listing Studio Job Step Model - Listing 工作流步骤
...
class ListingStudioJobStep(BaseModel):
    """Listing Studio 工作流步骤"""
    ...
    status: Mapped[str] = mapped_column(
        String(20),
        default=ListingStudioJobStepStatus.PENDING,
        nullable=False,
        index=True,
    )
    ...
    def __repr__(self) -> str:
        return f"<ListingStudioJobStep {self.id} {self.capability_id} {self.status}>"
